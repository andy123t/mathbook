...
This is the comments from Reviewer \thereviewer. With some more words foo bar foo bar ...
\begin{enumerate}
  \item Point one
  \item Point two
  %\item Point three
...
\begin{point*}[Reply]
This is our reply to Comment 1 from Reviewer \thereviewer.
\end{point*}
...
\begin{point*}[Reply]
This is our reply to Comment 2 from Reviewer \thereviewer.
\end{point*}
